          ...
          <div className="animate-in slide-in-from-right duration-300 max-w-lg mx-auto pb-10">
            ...
            <section className="space-y-4 px-1">
               ...
               <div className="grid grid-cols-2 gap-3">
                 ...
                 >
                    {isBackingUp ? <Loader2 size={24} className="animate-spin" /> : <Upload className="w-6 h-6 text-blue-500" />}
                 ...
                 >
                    {isRestoring ? <Loader2 size={24} className="animate-spin text-blue-600" /> : <Download size={24} className="text-blue-600" />}
                    <div className="text-center">
          ...
          <div className="space-y-6 max-w-lg mx-auto pb-10">
            ...
            <div className="grid grid-cols-1 gap-3 px-1">
               {[
                 ...
                 { id: 'sync', label: t('cloudSync'), icon: Upload, color: 'text-cyan-600', bg: 'bg-cyan-50 dark:bg-cyan-900/20' },
